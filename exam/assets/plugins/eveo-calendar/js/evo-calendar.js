...
;(function(factory) {
    ...
    EvoCalendar.prototype.buildEventList = function() {
        ...
        if(!hasEventToday) {
            markup = '<div class="event-empty custo-no-event-found">';
            ...
            // }
            if (_.$active.date === _.$current.date) {
                markup += `<img src="${base_url}assets/img/image_processing20210505-30944-1125boa.png" class="no-event-found-in-calendar" alt="No Event Found">`;
                // markup += '<p>'+_.initials.dates[_.options.language].noEventForToday+'</p>';
            } else {
                markup += `<img src="${base_url}assets/img/image_processing20210505-30944-1125boa.png" class="no-event-found-in-calendar" alt="No Event Found">`;
                // markup += '<p>'+_.initials.dates[_.options.language].noEventForThisDay+'</p>';
    ...
    EvoCalendar.prototype.addEventList = function(event_data) {
        ...
        if (event_data.badge == "Due") markup += '<span class="event-type-due">'+event_data.badge+'</span>';
        if (event_data.badge == "Appointment") markup += '<span class="event-type-appointments">'+event_data.badge+'</span>';
        markup += '</p>'
